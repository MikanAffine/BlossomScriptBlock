...
public class BFloat extends BNumber<Float>{

  private final float value;

  public BFloat(float v){
    value = v;
  }
  ...
  public boolean equals(Object obj){
    ...
    if(v instanceof Number) return value == ((Number) v).floatValue();
    return false;
  }
  ...
  public BObject<?> add(BObject<?> b){
    Object v = b.get();
    if(v instanceof Number) return new BFloat(value + ((Number) v).floatValue());
    return super.add(b);
  }
  ...
  public BBoolean eq(BObject<?> b){
    Object v = b.get();
    if(v instanceof Number) return BBoolean.by(value == ((Number) v).floatValue());
